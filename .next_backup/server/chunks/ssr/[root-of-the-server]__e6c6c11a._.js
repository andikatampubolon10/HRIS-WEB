...
`,_=({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:f,children:g,toasterId:h,containerStyle:i,containerClassName:j})=>{let{toasts:k,handlers:l}=H(d,h);return e.createElement("div",{"data-rht-toaster":h||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...i},className:j,onMouseEnter:l.startPause,onMouseLeave:l.endPause},k.map(d=>{let h,i,j=d.position||b,k=l.calculateOffset(d,{reverseOrder:a,gutter:f,defaultPosition:b}),m=(h=j.includes("top"),i=j.includes("center")?{justifyContent:"center"}:j.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:c?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${k*(h?1:-1)}px)`,...h?{top:0}:{bottom:0},...i});return e.createElement(Z,{id:d.id,key:d.id,onHeightUpdate:l.updateHeight,className:d.visible?$:"",style:m},"custom"===d.type?s(d.message,d):g?g(d):e.createElement(Y,{toast:d,position:j}))}))};a.s(["CheckmarkIcon",()=>Q,"ErrorIcon",()=>L,"LoaderIcon",()=>N,"ToastBar",()=>Y,"ToastIcon",()=>V,"Toaster",()=>_,"default",()=>F,"resolveValue",()=>s,"toast",()=>F,"useToaster",()=>H,"useToasterStore",()=>D],76246)},17190,a=>{"use strict";let b="http://localhost:8080/api/v1".startsWith("/")?"http://localhost:8080/api/v1":"/api/v1";function c(a){return b.startsWith("http")?`${b}${a}`:`http://localhost:3000${b}${a}`}function d(a){return"object"==typeof a&&null!==a}let e=new class{setAccessTokenCookie(a){}clearAccessTokenCookie(){}async login(a){try{let b,e=await fetch(c("/auth/login"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)}),f=await e.text();try{b=f?JSON.parse(f):{}}catch{throw Error(`Invalid JSON response (status ${e.status})`)}if(!e.ok){let a=b;throw Error(a.error||a.message||"Login failed")}let g=d(b)&&d(b.data)?b.data:b;if(!d(g))throw console.error("Invalid response structure:",b),Error("Invalid response from server");let h=g.access_token,i=g.refresh_token,j=g.expires_in,k=g.user;if("string"!=typeof h||"string"!=typeof i||"number"!=typeof j||!d(k))throw console.error("Invalid response structure:",b),Error("Invalid response from server");return g}catch(a){throw console.error("Login error:",a),a}}async logout(){let a=this.getAccessToken();if(a)try{await fetch(c("/logout"),{method:"POST",headers:{Authorization:`Bearer ${a}`}})}catch(a){console.error("Logout error:",a)}}async refreshToken(){let a=this.getRefreshToken();if(!a)throw Error("No refresh token available");try{let b,e=await fetch(c("/auth/refresh"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({refresh_token:a})}),f=await e.text();try{b=f?JSON.parse(f):{}}catch{throw Error(`Invalid JSON response (status ${e.status})`)}if(!e.ok){let a=b;throw Error(a.error||a.message||"Token refresh failed")}let g=d(b)&&d(b.data)?b.data:b;if(!d(g)||"string"!=typeof g.access_token)throw Error("Invalid refresh response");return g}catch(a){throw console.error("Refresh token error:",a),this.clearTokens(),a}}getAccessToken(){return null}getRefreshToken(){return null}getUser(){return null}isAuthenticated(){return!!this.getAccessToken()}clearTokens(){}getAuthHeaders(){let a=this.getAccessToken();return{"Content-Type":"application/json",...a?{Authorization:`Bearer ${a}`}:{}}}};a.s(["authService",0,e])},81550,(a,b,c)=>{"use strict";b.exports=a.r(42647).vendored.contexts.HooksClientContext},76907,(a,b,c)=>{"use strict";b.exports=a.r(42647).vendored.contexts.ServerInsertedHtml},18622,(a,b,c)=>{b.exports=a.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(a,b,c)=>{b.exports=a.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(a,b,c)=>{b.exports=a.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},20635,(a,b,c)=>{b.exports=a.x("next/dist/server/app-render/action-async-storage.external.js",()=>require("next/dist/server/app-render/action-async-storage.external.js"))},42647,(a,b,c)=>{"use strict";b.exports=a.r(18622)},12664,(a,b,c)=>{"use strict";b.exports=a.r(42647).vendored["react-ssr"].ReactJsxRuntime},87437,(a,b,c)=>{"use strict";b.exports=a.r(42647).vendored["react-ssr"].React},23223,(a,b,c)=>{"use strict";b.exports=a.r(42647).vendored.contexts.AppRouterContext},29712,(a,b,c)=>{"use strict";function d(a){if("function"!=typeof WeakMap)return null;var b=new WeakMap,c=new WeakMap;return(d=function(a){return a?c:b})(a)}c._=function(a,b){if(!b&&a&&a.__esModule)return a;if(null===a||"object"!=typeof a&&"function"!=typeof a)return{default:a};var c=d(b);if(c&&c.has(a))return c.get(a);var e={__proto__:null},f=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var g in a)if("default"!==g&&Object.prototype.hasOwnProperty.call(a,g)){var h=f?Object.getOwnPropertyDescriptor(a,g):null;h&&(h.get||h.set)?Object.defineProperty(e,g,h):e[g]=a[g]}return e.default=a,c&&c.set(a,e),e}},98052,(a,b,c)=>{"use strict";Object.defineProperty(c,"__esModule",{value:!0});var d={DEFAULT_SEGMENT_KEY:function(){return l},NOT_FOUND_SEGMENT_KEY:function(){return m},PAGE_SEGMENT_KEY:function(){return k},addSearchParamsIfPageSegment:function(){return i},computeSelectedLayoutSegment:function(){return j},getSegmentValue:function(){return f},getSelectedLayoutSegmentPath:function(){return function a(b,c,d=!0,e=[]){let g;if(d)g=b[1][c];else{let a=b[1];g=a.children??Object.values(a)[0]}if(!g)return e;let h=f(g[0]);return!h||h.startsWith(k)?e:(e.push(h),a(g,c,!1,e))}},isGroupSegment:function(){return g},isParallelRouteSegment:function(){return h}};for(var e in d)Object.defineProperty(c,e,{enumerable:!0,get:d[e]});function f(a){return Array.isArray(a)?a[1]:a}function g(a){return"("===a[0]&&a.endsWith(")")}function h(a){return a.startsWith("@")&&"@children"!==a}function i(a,b){if(a.includes(k)){let a=JSON.stringify(b);return"{}"!==a?k+"?"+a:k}return a}function j(a,b){if(!a||0===a.length)return null;let c="children"===b?a[0]:a[a.length-1];return c===l?null:c}let k="__PAGE__",l="__DEFAULT__",m="/_not-found"}];

//# sourceMappingURL=%5Broot-of-the-server%5D__e6c6c11a._.js.map