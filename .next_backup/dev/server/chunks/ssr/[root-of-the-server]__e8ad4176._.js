...
"[project]/hris-attendance-dashboard/app/dashboard/manager-hr/geofencing/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GeofencingPage() {
    ...
    const handleSaveChanges = async ()=>{
        try {
            if (configData.id) {
                // Update existing
                await __TURBOPACK__imported__module__$5b$project$5d2f$hris$2d$attendance$2d$dashboard$2f$lib$2f$api$2f$geofence$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["geofenceApi"].update(configData.id, {
                ...
                // Create new
                await __TURBOPACK__imported__module__$5b$project$5d2f$hris$2d$attendance$2d$dashboard$2f$lib$2f$api$2f$geofence$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["geofenceApi"].create({
                    name: configData.name,
                    description: '',
                    latitude: configData.latitude,
                    longitude: configData.longitude,
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                        onClick: ()=>{
                                                                            if (confirm(`Hapus lokasi "${geofence.name}"?`)) {
                                                                                __TURBOPACK__imported__module__$5b$project$5d2f$hris$2d$attendance$2d$dashboard$2f$lib$2f$api$2f$geofence$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["geofenceApi"].delete(geofence.id).then(()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e8ad4176._.js.map