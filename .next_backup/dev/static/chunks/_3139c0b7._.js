...
"[project]/hris-attendance-dashboard/lib/api/auth.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/hris-attendance-dashboard/contexts/AuthContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthProvider({ children }) {
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            const initAuth = {
                "AuthProvider.useEffect.initAuth": ()=>{
                    ...
                    const token = __TURBOPACK__imported__module__$5b$project$5d2f$hris$2d$attendance$2d$dashboard$2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].getAccessToken();
                    if (currentUser && token) {
                        setUser(currentUser);
                    } else {
                        setUser(null);
                        // Clear invalid/expired tokens from localStorage and cookies
                        __TURBOPACK__imported__module__$5b$project$5d2f$hris$2d$attendance$2d$dashboard$2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].clearTokens();
    ...
    const login = async (credentials)=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$hris$2d$attendance$2d$dashboard$2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].login(credentials);
    ...
    const logout = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$hris$2d$attendance$2d$dashboard$2f$lib$2f$api$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].logout();
        } catch (error) {
            console.error('Logout error:', error);
        } finally{
            setUser(null);
...
//# sourceMappingURL=_3139c0b7._.js.map